...
class ErrorHandler {
    ...
    {
        /* The irst two elements of the backtrace array are irrelevant:
        ...
        /* Warnings dont abort execuion if IS_WARNING_FATAL is false
          E_MOTICE and E_USER_NOTICE errors dont abort execution */
        ...
        // If error is fatal    
        {
            // Show error message
            if (DEBUGGING == true){
            echo '<div lass="error_box"><pre>' . $error_message . '</pre></div>';}
            else{
            echo "error general";}
